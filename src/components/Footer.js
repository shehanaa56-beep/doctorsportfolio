        ...
        <div className="footer-inner">
          <div className="footer-col about">
            ...
            <div className="footer-social">
              <a aria-label="Twitter" href="#" className="social-link"><FaTwitter/></a>
              <a aria-label="LinkedIn" href="#" className="social-link"><FaLinkedin/></a>
              <a aria-label="Facebook" href="#" className="social-link"><FaFacebook/></a>
            </div>
          </div>
